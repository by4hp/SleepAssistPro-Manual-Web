    ...
    items: [
      {
        id: 'personal-info',
        title: '6.1 修改个人资料',
        content: `如果您想更新昵称、单位、身高体重或语言设置，请先打开 Personal Information。这些内容会影响您在 App 里的个人显示，以及部分数据的展示方式。`,
        children: [
          {
      ...
      },
      {
        id: 'data-sharing',
        title: '6.2 管理睡眠数据与分享',
        content: `如果您想删除睡眠数据、下载数据，或查看分享内容，请打开 Data & Sharing Settings。这一页用来管理您自己的睡眠记录，以及别人分享给您的报告。`,
        children: [
          {
